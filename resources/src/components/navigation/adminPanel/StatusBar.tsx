...
const StatusBar: React.FC = () => {
    return (
        <div className="  justify-center sm:items-center  w-full flex md:justify-between items-center h-20 shadow-xl px-4 sm:px-10 md:px-16 ">
            <Link to='/' className="text-xl sm:text-2xl md:text-3xl font-bold select-none">
                Smart PC
            </Link>
            <div>
                <span>
